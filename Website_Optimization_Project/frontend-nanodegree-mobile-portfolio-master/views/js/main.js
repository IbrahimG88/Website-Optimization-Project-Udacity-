...
//I changed querySelectorAll with getElementsByClassName
//I am moving var dx and newwidth variables outside the loop:

//modified the  the randomPizzacontainer index from [i] to [0]


//modification: the array length is stored in a local variable "len"

  var dx = determineDx(document.getElementsByClassName("randomPizzaContainer")[0], size);
     var newwidth = (document.getElementsByClassName("randomPizzaContainer")[0].offsetWidth + dx) + 'px';

//modified the folowing loop
...
//modification: pizzasDiv is declared outside the for loop to reduce the DOM load
...
//changed the items variable outside the updatePositions() function and made it a global variable
...
function updatePositions() {
  ...
  //modification: phase is declared inside the for loop, btu the unchanged
  //top variable is declared outside the for loop.
var top = document.body.scrollTop / 1250;
//Student;s note: changed querySelectorAll to getElementsByClassName('');
...
//added by me
  ...
  //will move this line outside the for loop:
...
//modification: background pizzas number is increased to 24 instead of 20
  //student's note: changed the number of pizaas animated in the background from 200 to 20
  
//modification: elem variable is declared in the loop initialize space to reduce DOM load

//modification:movingPizzas local variable and querySelector DOM call is
